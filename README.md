...
* [Tests](https://github.com/4r7hu3/data-science-learning/tree/main/Tests) - While reading Wes McKinney's book, I was going to try to reproduce some examples and exercises. There's also a Markdown file here, that despite it's not one of the contents of the book, was part of my plans to learn. 

* [Visualization](Visualization) - These are some good practices and recommendations about the use of charts, according to your purposes. 
